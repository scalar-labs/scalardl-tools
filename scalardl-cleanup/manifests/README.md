...
`ledger-ad/configmap.yaml` or `auditor-ad/configmap.yaml`).
...
**c. Config.** Set `scalar.db.contact_points` and `scalar.dl.client.auditor.host` in `auditor-ad/configmap.yaml` (
for TLS,
