...
class CoordinatorCleanupOrchestratorTest {
  ...
  static Stream<Arguments> invalidTokenProvider() {
    ...
    return Stream.of(
        ...
        Arguments.of(
            ...
            ScalarDlCleanupError.COMPLETION_TOKEN_DECODE_FAILED),
        ...
        Arguments.of(
            ...
            ScalarDlCleanupError.LEDGER_TOKEN_WRONG_SERVER_TYPE),
        // A Ledger token supplied in the Auditor slot.
        Arguments.of(
            createLedgerToken(1000L),
            createLedgerToken(2000L),
            ScalarDlCleanupError.AUDITOR_TOKEN_WRONG_SERVER_TYPE));
  }
  ...
  @Test
  void create_jdbcTransactionManagerGiven_shouldThrowScalarDlCleanupException() {
    // Arrange
    Properties props = new Properties();
  ...
  void execute_invalidTokenGiven_shouldThrowException(
      String ledgerToken, String auditorToken, ScalarDlCleanupError expected) {
    // Arrange
    CoordinatorCleanupOrchestrator orchestrator =
        newOrchestrator(CoordinatorStateAccessor.NAMESPACE, ledgerToken, auditorToken);
  ...
  void execute_noCheckpointAndMissingTokenGiven_shouldThrowException(
    ...
    assertThatThrownBy(orchestrator::execute)
        .isInstanceOf(ScalarDlCleanupException.class)
        .hasMessageContaining(ScalarDlCleanupError.BOTH_COMPLETION_TOKENS_REQUIRED.buildCode());
  }
