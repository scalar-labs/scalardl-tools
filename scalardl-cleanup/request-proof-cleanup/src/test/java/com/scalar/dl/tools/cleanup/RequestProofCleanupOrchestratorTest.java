...
class RequestProofCleanupOrchestratorTest {
  ...
  void execute_corruptedTokenGiven_shouldThrowException() {
    ...
    assertThatThrownBy(orchestrator::execute)
        .isInstanceOf(ScalarDlCleanupException.class)
        .hasMessageContaining(ScalarDlCleanupError.COMPLETION_TOKEN_DECODE_FAILED.buildCode());
  }
  ...
  void execute_ledgerTokenGiven_shouldThrowWrongServerType() {
    ...
    assertThatThrownBy(orchestrator::execute)
        .isInstanceOf(ScalarDlCleanupException.class)
        .hasMessageContaining(ScalarDlCleanupError.AUDITOR_TOKEN_WRONG_SERVER_TYPE.buildCode());
  ...
  void execute_noCheckpointAndMissingTokenGiven_shouldThrowException() {
    ...
    assertThatThrownBy(orchestrator::execute)
        .isInstanceOf(ScalarDlCleanupException.class)
        .hasMessageContaining(ScalarDlCleanupError.AUDITOR_COMPLETION_TOKEN_REQUIRED.buildCode());
  }
