...
public class CommonTest {
  ...
  @Test
  void printError_givenCoordinatorStateDeleterException_shouldUseItsCategory() throws Exception {
    // Arrange
    CoordinatorStateDeleterException exception =
        new CoordinatorStateDeleterException("bad config", Category.USER_ERROR);
