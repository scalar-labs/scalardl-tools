...
class DeleteRequestProofHandlerTest {

  private RequestProofDeletionChecker deletionChecker;
  private RequestProofDeleter recordDeleter;
  private DeleteRequestProofHandler handler;

  @BeforeEach
  void setUp() {
    deletionChecker = mock(RequestProofDeletionChecker.class);
    recordDeleter = mock(RequestProofDeleter.class);
    handler = new DeleteRequestProofHandler(deletionChecker, recordDeleter);
  }
